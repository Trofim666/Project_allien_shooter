...
class BattleField(tk.Canvas):
    def __init__(self, master):
        ...
        self.k_func = 0
        self.over = 0
        self.screen1 = self.create_text(400, 300, text='', font='28')
        self.itemconfig(self.screen1, text='LOH')
        self.all_points = 0
    ...
    def start_after_game_over(self):
        global balls, enemys, boxes, medes
